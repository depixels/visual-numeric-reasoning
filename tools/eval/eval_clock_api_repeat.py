#!/usr/bin/env python3
"""Run eval_clock_api.py multiple times and aggregate run-level and sample-level stability."""
...
def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Repeat eval_clock_api.py and aggregate metrics")
